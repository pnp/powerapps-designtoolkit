...
1. Import [Solution file](solution/MaterialDesignComponentLibrary_1_0_0_4.zip) to all environments you want to develop canvas apps using the components
